...
CLASSIFICATION: dict[str, tuple] = {
    ...
    # ── Этап 5: линейный equity + future/warrant ─────────
    ...
    "equity_future": (_A.EQUITY, _MF.ANALYTIC, _M.CLOSED_FORM),
    "warrant": (_A.EQUITY, _MF.ANALYTIC, _M.CLOSED_FORM),
    # ── Money market ──────────────────────────────────────
    "term_deposit": (_A.RATES, _MF.ANALYTIC, _M.CLOSED_FORM),
    # ── Credit ────────────────────────────────────────────
    ...
    "cds_index_option": (_A.CREDIT, _MF.REDUCED_FORM, _M.CLOSED_FORM),
