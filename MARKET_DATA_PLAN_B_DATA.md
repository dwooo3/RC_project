...
> **СТАТУС: ✅ ВЫПОЛНЕНО 2026-07-02** — коммиты `0ea9001` (B1+B2 YTM/G-spread/
> сортировка), `5f4d05e` (B3 кривая фьючерсов), `39900fc` (B5 див-доходность),
> `54df5c8` (B6 статы 52w/RV/DD), `e4a76f9` (B7 RV-vs-IV + B8 RR/BF skew).
> B4/B9 закрыты фазой 1 (PLAN A: A2/A3). Живые цифры: 3000 бондов с YTM,
> 2930 с G-spread; 54 акции с див-доходностью; Si RV30 16.05% vs ATM 16.3%.
